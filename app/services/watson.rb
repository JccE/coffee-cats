...
# 	def detect_kitty
# 		api_call =  "https://gateway-a.watsonplatform.net/visual-recognition/api/v3/classify?api_key={ENV}&url=https://www.petfinder.com/wp-content/uploads/2012/11/91615172-find-a-lump-on-cats-skin-632x475.jpg&version=2016-05-19"

# 		puts Net::HTTP.get(api_call)
